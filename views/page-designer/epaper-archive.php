...
$this->title = 'Edit Layout: Epaper Archive';

// current page
$current = 'epaper-archive';
                    ...
                    <div class="layout-select-wrap">
                        <select class="form-control input-sm"
                            ...
                            <option value="<?= Html::encode($links['epaper-archive']) ?>"
                                <?= $current==='epaper-archive' ? 'selected' : '' ?>>
                                Epaper Archive
                            </option>
            ...
            <div style="border:1px solid #d1d5db; margin-bottom:10px; background:#f5f7fb;">
                ...
                <div style="padding:8px 10px;">
                    <div style="border:1px solid #d7dde6; background:#ffffff;">
                        ...
                        <!-- Widgets: HeadingWidget + ShareWidget -->
<div style="padding:6px 0 10px 0; background:#ffffff;">
    ...
    ">
        <div style="display:flex; align-items:center; gap:4px;">
            ...
            <!-- SECOND row: 2 columns (left: Image+Archive, right: 2x Image + Calendar) -->
<div style="border:1px solid #d1d5db; margin-bottom:10px; background:#f5f7fb;">
    ...
    <div style="padding:8px 10px; display:flex; gap:10px;">
        ...
        <div style="flex:2; border:1px solid #d7dde6; background:#ffffff;">
            ...
            <!-- LEFT column widgets: ImageWidget + ArchiveWidget -->
            <div style="padding:0 0 6px 0; background:#ffffff;">
                <!-- ImageWidget line -->
                <div style="
                    border-top:1px solid #d7dde6;
                    border-bottom:1px solid #d7dde6;
        ...
        <div style="flex:1; border:1px solid #d7dde6; background:#ffffff;">
            ...
            <div style="padding:0 0 6px 0; background:#ffffff;">
                ...
                <!-- Archive label + CalendarWidget -->
                <div style="font-size:11px; margin:3px 6px 2px 6px;">
                    Archive
                </div>
                <div style="
        ...
        <div class="tab-pane" id="backups">
            <p>Layout backups for Epaper Archive yahan dikhenge.</p>
        </div>
    </div>
</div>
