...
$this->title = 'Edit Layout: Epaper Map';
...
<div class="box-style" style="padding:0;">
    ...
    <div class="tab-content" style="padding:10px 15px 15px;">
        <div class="tab-pane active" id="designer">
            ...
            <!-- ROW 1: AreaMapTitleWidget + ShareWidget -->
                        ...
                        <div style="padding:0 0 6px 0; background:#ffffff;">
                            ...
                            <div class="widget-line">
                                <div class="widget-tools">
                                    <span class="widget-pill">AreaMapTitleWidget</span>
            ...
            <div style="border:1px solid #d1d5db; margin-bottom:10px; background:#f5f7fb;">
                ...
                <div style="padding:8px 10px;">
                    <div style="border:1px solid #d7dde6; background:#ffffff;">
                        ...
                        <div class="widget-line">
                            <div class="widget-tools">
                                <span class="widget-pill">AreaMapWidget</span>
                                <button class="btn btn-default btn-xs"><i class="glyphicon glyphicon-duplicate"></i></button>
                                <button class="btn btn-success btn-xs"><i class="glyphicon glyphicon-edit"></i></button>
                                <button class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></button>
                            </div>
        ...
        <div class="tab-pane" id="backups">
            <p>Layout backups for Epaper Map yahan dikhenge.</p>
        </div>
    </div>
</div>
