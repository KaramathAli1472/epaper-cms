...
$this->title = 'Edit Layout: Epaper Display';

// current page
$current = 'epaper-display';
...
<div class="box-style" style="padding:0;">
    ...
    <div class="tab-content" style="padding:10px 15px 15px;">
        <div class="tab-pane active" id="designer">
                    ...
                    <div class="layout-select-wrap">
                        <select class="form-control input-sm"
                            ...
                            <option value="<?= Html::encode($links['epaper-display']) ?>"
                                <?= $current==='epaper-display' ? 'selected' : '' ?>>
                                Epaper Display
                            </option>
            ...
            <div style="border:1px solid #d1d5db; margin-bottom:10px; background:#f5f7fb;">
                ...
                <div style="padding:8px 10px; display:flex; gap:10px;">
                    ...
                    <!-- Column 1: PagerWidget -->
                    <div style="flex:1; border:1px solid #d7dde6; background:#ffffff;">
                        <div style="
                            padding:6px 8px;
                            background:#f4f7fb;
                        ...
                        <div class="widget-line">
                            <div class="widget-tools">
                                <span class="widget-pill">PagerWidget</span>
                                <button class="btn btn-default btn-xs"><i class="glyphicon glyphicon-duplicate"></i></button>
                                <button class="btn btn-success btn-xs"><i class="glyphicon glyphicon-edit"></i></button>
                                <button class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></button>
                            </div>
                        </div>
                    </div>

                    <!-- Column 2: PagerWidget -->
                    <div style="flex:1; border:1px solid #d7dde6; background:#ffffff;">
                        <div style="
                            padding:6px 8px;
                            background:#f4f7fb;
                    ...
                    <div style="flex:1; border:1px solid #d7dde6; background:#ffffff;">
                        ...
                        <div class="widget-line">
                            <div class="widget-tools">
                                <span class="widget-pill">PDFDownloadWidget</span>
                                <button class="btn btn-default btn-xs"><i class="glyphicon glyphicon-duplicate"></i></button>
                                <button class="btn btn-success btn-xs"><i class="glyphicon glyphicon-edit"></i></button>
                                <button class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></button>
                            </div>
                    ...
                    <!-- Column 4: CalendarWidget + ClipAndShareWidget -->
                    <div style="flex:1; border:1px solid #d7dde6; background:#ffffff;">
                        <div style="
                            padding:6px 8px;
                            background:#f4f7fb;
                        ...
                        <div class="widget-line">
                            <div class="widget-tools">
                                <span class="widget-pill">CalenderWidget</span>
                                <button class="btn btn-default btn-xs"><i class="glyphicon glyphicon-duplicate"></i></button>
                                <button class="btn btn-success btn-xs"><i class="glyphicon glyphicon-edit"></i></button>
                                <button class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></button>
                            </div>
                        ...
                        <div class="widget-line">
                            <div class="widget-tools">
                                <span class="widget-pill">ClipAndShareWidget</span>
                                <button class="btn btn-default btn-xs"><i class="glyphicon glyphicon-duplicate"></i></button>
                                <button class="btn btn-success btn-xs"><i class="glyphicon glyphicon-edit"></i></button>
                                <button class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></button>
                            </div>
            ...
            <div style="border:1px solid #d1d5db; margin-bottom:10px; background:#f5f7fb;">
                ...
                <div style="padding:8px 10px; display:flex; gap:10px;">
                    ...
                    <!-- Left column Heading+Share+Display -->
                    <div style="flex:2; border:1px solid #d7dde6; background:#ffffff;">
                        <div style="
                            padding:6px 8px;
                            background:#f4f7fb;
                            border-bottom:1px solid #e3e7ef;
                        ...
                        <div class="widget-line">
                            <div class="widget-tools">
                                <span class="widget-pill">HeadingWidget</span>
                                <button class="btn btn-default btn-xs"><i class="glyphicon glyphicon-duplicate"></i></button>
                                <button class="btn btn-success btn-xs"><i class="glyphicon glyphicon-edit"></i></button>
                                <button class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></button>
                            </div>
                        ...
                        <div class="widget-line">
                            <div class="widget-tools">
                                <span class="widget-pill">ShareWidget</span>
                                <button class="btn btn-default btn-xs"><i class="glyphicon glyphicon-duplicate"></i></button>
                                <button class="btn btn-success btn-xs"><i class="glyphicon glyphicon-edit"></i></button>
                                <button class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></button>
                            </div>
                        ...
                        <div class="widget-line">
                            <div class="widget-tools">
                                <span class="widget-pill">DisplayWidget</span>
                                <button class="btn btn-default btn-xs"><i class="glyphicon glyphicon-duplicate"></i></button>
                                <button class="btn btn-success btn-xs"><i class="glyphicon glyphicon-edit"></i></button>
                                <button class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></button>
                            </div>
                    ...
                    <div style="flex:1; border:1px solid #d7dde6; background:#ffffff;">
                        ...
                        <div class="widget-line">
                            <div class="widget-tools">
                                <span class="widget-pill">ThumbNavWidget</span>
                                <button class="btn btn-default btn-xs"><i class="glyphicon glyphicon-duplicate"></i></button>
                                <button class="btn btn-success btn-xs"><i class="glyphicon glyphicon-edit"></i></button>
                                <button class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></button>
                            </div>
            ...
            <div style="border:1px solid #d1d5db; margin-bottom:10px; background:#f5f7fb;">
                ...
                <div style="padding:8px 10px;">
                    <div style="border:1px solid #d7dde6; background:#ffffff;">
                        ...
                        <!-- bottom widgets: Pager, Pager, Calendar, ClipAndShare, PDFDownload -->
                        <?php
                        $bottomWidgets = [
                            'PagerWidget',
                            'PagerWidget',
                        ...
                        ?>
                        <?php foreach ($bottomWidgets as $w): ?>
                            <div class="widget-line">
                                <div class="widget-tools">
                                    <span class="widget-pill"><?= Html::encode($w) ?></span>
                                    <button class="btn btn-default btn-xs"><i class="glyphicon glyphicon-duplicate"></i></button>
                                    <button class="btn btn-success btn-xs"><i class="glyphicon glyphicon-edit"></i></button>
                                    <button class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></button>
                                </div>
        ...
        <div class="tab-pane" id="backups">
            <p>Layout backups for Epaper Display yahan dikhenge.</p>
        </div>
    </div>
</div>
