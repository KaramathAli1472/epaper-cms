...
<div class="slider-index box-style">
    ...
    <div class="top-bar">
        ...
        <div class="top-bar-left">
            <?= Html::a('<i class="fa fa-plus"></i> New Slideshow', ['create'], [
    'class' => 'btn btn-primary btn-create',
]) ?>
        </div>

        <!-- Right: Search + Go + Reset (simple GET q example) -->
        <div class="top-bar-right">
            <form method="get" class="form-inline">
                <div class="input-group input-group-sm">
                    ...
                    <span class="input-group-btn">
                        <a href="<?= \yii\helpers\Url::to(['slider/index']) ?>" class="btn btn-default">Reset</a>
                    </span>
                </div>
            </form>
        </div>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
                ...
                'buttons' => [
                    ...
                    'delete' => function ($url, $model) {
                        return Html::a('<i class="fa fa-trash"></i>', $url, [
                            ...
                            'title' => 'Delete',
                            'data-confirm' => 'Delete this slider?',
                            'data-method' => 'post',
                            'data-pjax' => '0',
                        ]);
                    },
            ...
            // Slider Title (ya caption)
            [
                'attribute' => 'title',   // agar field ka naam alag ho to change karo
                'label' => 'Slider Title',
                'format' => 'raw',
